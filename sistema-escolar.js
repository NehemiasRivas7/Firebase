...
// Importar la conexión a Firebase (db = database)
...
//Crear referencias a nuestras colecciones (como "tablas" en SQL)
...
async function mostrarAlumnos() {
  try {
    ...
    // Encontrar el contenedor en el HTML
...
async function mostrarNotas() {
  try {
    ...
    // Crear tabla HTML con todos los datos relacionados
    container.innerHTML = `
